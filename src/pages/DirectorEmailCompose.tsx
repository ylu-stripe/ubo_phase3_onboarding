...
export const DirectorEmailCompose: React.FC = () => {
  ...
  const handleSend = () => {
    const emailToSend = email || `${director.name.toLowerCase().replace(/\s+/g, '.')}@example.com`;
  ...
  return (
    <div className="layout-with-sidebar">
      ...
      <div className="main-content-with-sidebar">
        <OnboardingNav onBack={() => navigate(`/directors/${id}?returnTo=${returnTo}`)} />
        <div className="page-content">
          <button 
            onClick={() => navigate(`/directors/${id}?returnTo=${returnTo}`)}
            style={{
              background: "none",
              border: "none",
              color: "#6366f1",
          ...
          <div className="page-header">
            <h1 className="page-title">Send a verification link to director</h1>
          ...
          <div style={{ marginBottom: "1.5em" }}>
            ...
            <p style={{ color: "#6b7280", fontSize: "0.95em", lineHeight: 1.6, margin: 0 }}>
              The director will receive a link via their email address to verify their identity by capturing a photo ID and selfie. Verification could take up to 2-3 days.
            </p>
          </div>
              ...
              <div style={{
                ...
                <div style={{ marginBottom: "1.5em" }}>
                  <div style={{ fontWeight: 600, marginBottom: "1em" }}>
                    Complete identity verification for {director.name}
                  </div>
                  <div style={{ fontSize: "0.95em", color: "#4b5563", lineHeight: 1.6 }}>
                    To verify {director.name}'s identity, you'll need to provide a photo of their ID.{" "}
...
export default DirectorEmailCompose;
